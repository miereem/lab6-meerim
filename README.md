...
min_by_cave : вывести любой объект из коллекции, значение поля cave которого является минимальным
...
private Long y; //Значение поля должно быть больше -511, Поле не может быть null
}
